...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endpoint" do
    assert_difference('Endpoint.count') do
      post endpoints_url, params: { endpoint: { description: @endpoint.description, name: @endpoint.name } }
    end
  ...
  test "should update endpoint" do
    patch endpoint_url(@endpoint), params: { endpoint: { description: @endpoint.description, name: @endpoint.name } }
